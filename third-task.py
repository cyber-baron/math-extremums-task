import sympy
from sympy import Lambda, log, Derivative, diff, Rational, simplify, linsolve, lambdify, exp, solve
...
ax.plot_surface(x_mesh, y_mesh, z_mesh, alpha=0.55, cmap = 'coolwarm')
